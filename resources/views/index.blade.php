    ...
    {{-- <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="contact">
      <div class="my-auto">
        <h3 class="mb-5">What's Next?</h3>
            ...
            <h2> Get In Touch</h2>
            <p> I’m  currently looking for any new opportunities, 
               inbox is always open. Whether you have a question or just want to say hi, 
               I’ll try my best to get back to you!</p>
        
               <a href="mailto:name@email.com" class="btn btn-warning btn-lg active button-rouded" role="button" >Say Hello</a>
      </div>
